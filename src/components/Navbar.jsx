...
export function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-10 bg-transparent w-full bg-transparent">
          ...
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link
                  to={item.href}
                  className="inline-flex font-semibold items-center text-sm  text-gray-800 hover:text-gray-900 hover:underline duration-200 ease-linear underline-offset-2 decoration-blue-500 decoration-2"
                >
                  {item.name}
                  {/* <span>
